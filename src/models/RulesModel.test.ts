...
import {OVERCAST_WEATHER_OPTION, RAIN_WEATHER_OPTION, SUNNY_WEATHER_OPTION} from "src/models/ForecastModel.ts"
import {SPRAY_WORK_OPTION, TRIM_WORK_OPTION, WATER_WORK_OPTION, WEED_WORK_OPTION} from "src/models/WorkOptionModel.ts"

test('RulesModel constructor works as expected', () => {
